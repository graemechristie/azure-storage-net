...
namespace Microsoft.WindowsAzure.Storage.Blob
{
    ...
    public class CloudBlobContainerTest : BlobTestBase
    {
        ...
        [Category(ComponentCategory.Blob)]
        [Category(TestTypeCategory.UnitTest)]
        [Category(SmokeTestCategory.NonSmoke)]
		[Category(TenantTypeCategory.Cloud)]
        ...
        public async Task CloudBlobContainerCreateAsync()
        {
			...
			Assert.Throws<AggregateException>(
                () => container.CreateAsync(BlobContainerPublicAccessType.Off, null, operationContext).Wait(),
        ...
        public async Task CloudBlobContainerListBlobsAsync()
        {
            ...
            try
            {
                ...
                {
					Assert.That(blobItem, Is.InstanceOf<CloudPageBlob>());
        ...
        public async Task CloudBlobContainerGetBlobReferenceFromServerAsync()
        {
            ...
            try
            {
				...
				Assert.That(blob, Is.InstanceOf<CloudBlockBlob>());
				...
				Assert.That(blob, Is.InstanceOf<CloudPageBlob>());
